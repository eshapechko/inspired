  ...
  <div class="container">
    <div class="footer__container">
      ...
      <div class="footer__item footer__item_social footer-social">
        ...
        <ul class="footer-social__list">
          <li class="footer-social__item">
            <a
              href="#"
              class="footer-social__link footer-social__link_vk footer__link"
            >
              <svg
                width="24"
                height="24"
          ...
          <li class="footer-social__item">
            <a
              href="#"
              class="footer-social__link footer-social__link_fb footer__link"
            >
              <svg
                width="24"
                height="24"
      ...
      <div class="footer__item footer__item_contacts footer-contacts">
        <a class="footer__link" href="mailto:Inspired@gmail.com"
          >Inspired@gmail.com</a
        >
      ...
      <div class="footer__item footer__item_development footer-development">
        <ul class="footer-development__list">
          <li class="footer-development__item">
            Designer:
            <a class="footer__link" href="https://t.me/Mrshmallowww"
              >Anastasia Ilina</a
            >
          </li>
          ...
          <li class="footer-development__item">
            Developer:
            <a class="footer__link" href="https://t.me/eshapechko"
              >Evgeniy Shapechko</a
            >
          </li>
        </ul>
